      ...
      <div className='nav__wrapper d-flex align-items-center justify-content-between'>
        ...
        <div className='navigation' ref={menuRef}>
            <div className='nav d-flex align-items-center gap-5'>
              <div><NavLink to="/" className="meu">Home</NavLink></div>
              <div><NavLink to="/menu" className="meu ">Menu</NavLink></div>
              <div><NavLink to="/aboutUs" className="meu ">About Us</NavLink></div>
            </div>
        </div>
        <div className='nav__right d-flex align-items-center gap-4'>
          ...
          <div ><NavLink to="/Sign" className="signIn">Sign In</NavLink></div>
        </div>
      </div>
      </Container>
    </div>
